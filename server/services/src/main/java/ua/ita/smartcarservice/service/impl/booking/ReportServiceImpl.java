...
import ua.ita.smartcarservice.entity.booking.BookingRequest;
...
public class ReportServiceImpl implements ReportService {
    ...
    private ReportExtendedDto reportEntityToExtendedDto(ReportEntity report) {
        ...
        BookingRequest request = BookingRequest.getOne().setName("Name")
                .setCarValue("Value").setPrice(100).setWorkers(20);
        BookingRequest nextRequest = BookingRequest.getOne().setValue("SecondValue").setWorkers(11);
